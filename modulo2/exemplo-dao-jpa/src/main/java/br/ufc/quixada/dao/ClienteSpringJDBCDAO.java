...
public class ClienteSpringJDBCDAO implements ClienteDAO {
	...
	public void save(Cliente entity) {
		String insert_sql = "insert into cliente (cpf, nome, fone, renda) values (:cpf, :nome, :fone, :renda)";
		String update_sql = "update cliente set cpf = :cpf, nome = :nome, fone = :fone, renda = :renda where id = :id";
	...
	public Cliente find(int id) {
		...
		try {
			String sql = "select id, cpf, nome, fone, renda from cliente where id = :id";
			MapSqlParameterSource params = new MapSqlParameterSource()
				.addValue("id", id);
	...
	public List<Cliente> find() {
			String sql = "select id, cpf, nome, fone, renda from cliente";
	...
	public Cliente findByCpf(String cpf) {
		Cliente cliente = null;
		try {
			String sql = "select id, cpf, nome, fone, renda from cliente where cpf = :cpf";
			MapSqlParameterSource params = new MapSqlParameterSource()
				.addValue("cpf", cpf);
			cliente = jdbcTemplate.queryForObject(sql, params, (rs, rowNum) -> map(rs));
		} catch (EmptyResultDataAccessException e) {
	...
	public List<Cliente> findByNome(String str) {
		String sql = "select id, cpf, nome, fone, renda from cliente where upper(nome) like :nome";
		MapSqlParameterSource params = new MapSqlParameterSource()
