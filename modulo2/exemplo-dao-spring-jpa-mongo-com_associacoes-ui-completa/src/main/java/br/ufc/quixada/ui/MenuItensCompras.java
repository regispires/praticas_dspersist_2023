			...
			try {
				...
				switch (opcao) {
					...
					case '2':     // Atualizar por id
						id = JOptionPane.showInputDialog("Digite o id do item de compra a ser alterado");
					...
					case '3':     // Remover por id
						id = JOptionPane.showInputDialog("Digite o id do item compra a ser removido");
						ic = baseItensCompras.findById(id).orElse(null);
						if (ic != null) {
					...
					case '4':     // Exibir por id
						id = JOptionPane.showInputDialog("Digite o id do item compra a ser exibido");
						ic = baseItensCompras.findById(id).orElse(null);
						if (ic != null) {
							listaItemCompra(ic);
						} else {
