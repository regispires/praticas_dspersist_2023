			...
			try {
				...
				switch (opcao) {
					...
					case '2':     // Atualizar por id
						id = Integer.valueOf(JOptionPane.showInputDialog("Digite o id do produto a ser alterado"));
					...
					case '3':     // Remover por id
						id = Integer.valueOf(JOptionPane.showInputDialog("Digite o id do produto a ser removido"));
						prod = baseProdutos.findById(id).orElse(null);
						if (prod != null) {
					...
					case '4':     // Exibir por id
						id = Integer.parseInt(JOptionPane.showInputDialog("Digite o id do produto a ser exibido"));
						prod = baseProdutos.findById(id).orElse(null);
						if (prod != null) {
							listaProduto(prod);
						} else {
